...
| 模块 | 产品 | 研发 | 职能 | 设计创意 |
|---|---|---|---|---|
| Header / Summary | 必有 | 必有 | 必有 | 必有，作品集链接必放 |
| Experience | 必有 | 必有 | 必有 | 必有 |
| Projects | 有开源/副业才放 | **强烈建议**（GitHub） | 可改为“活动/Campaign” | 可改为“作品/独立项目” |
| Skills | 分组简列 | 分组详列 | 简列 | 分组列能力、工具与落地经验 |
| Education | 简（1-2 行） | 简 | 简 | 简 |
| Extras | 只留加分的 | 可省 | 证书相关可留 | 奖项、展览与出版经历可留 |
